      ...
      <div className="min-h-screen">
        ...
        <div className="relative h-96 overflow-hidden">
          ...
          <button
            ...
            className="absolute top-6 left-6 flex items-center space-x-2 bg-[#A08647]/90 backdrop-blur-sm border border-[#A08647]/20 rounded-full px-4 py-2 text-white hover:bg-[#A08647] transition-all duration-300"
          >
